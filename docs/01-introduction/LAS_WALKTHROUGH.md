...
first, and why) see `docs/04-evaluation/PROJECT_HISTORY_EXPLAINED.md`; for the on-chain gas
experiment in plain English see `docs/03-results/GAS_LIMIT_INVESTIGATION.md`.
...
`docs/02-methodology/THEORY_IMPL_BRIDGE.md`; the design write-up is `docs/LAS.md §3–4`.)*
...
of its functions** (`docs/02-methodology/FUNCTION_MAP.md`). The new pieces:
...
`docs/02-methodology/THEORY_IMPL_BRIDGE.md` (paper equation → exact C function),
`docs/02-methodology/FUNCTION_MAP.md` (what was reused vs added), `docs/STATUS.md` (the

...
story see `docs/LAS_WALKTHROUGH.md`; for the gas experiment specifically see
...
**change none of it** — later proven in `docs/FUNCTION_MAP.md` (zero upstream
...
**New file:** `docs/THEORY_IMPL_BRIDGE.md` (plus a literature section in `docs/LAS.md`).
...
**corrects** the claim — see `docs/GAS_LIMIT_INVESTIGATION.md`.
...
(deliverable D15) and explained in `docs/GAS_LIMIT_INVESTIGATION.md`.

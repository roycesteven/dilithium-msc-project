...
% 3.2, 3.7, 3.8 and figure 3.6 each ended up on a text-free page. Raising it to 0.88
% (kept below topfraction, so a tall float can still take a page when nothing else
% will do) makes LaTeX prefer a top float with text under it.

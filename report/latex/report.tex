...
\usepackage{longtable}       % page-breaking tables (tab:notation is taller than a page)
...
% Widow/orphan control, document level.  Several pages were opening with a single
% paragraph-final line (a widow).  These are the standard TeX penalties: they forbid the
% break rather than patching individual pages with \enlargethispage, which is
% pagination-dependent and goes stale on the next edit.
\widowpenalty=10000
\clubpenalty=10000

...
Blockchains authenticate transactions with elliptic-curve signatures that a large quantum
computer would break. Basic post-quantum signatures are now standardised, but the
...
in the post-quantum setting. This dissertation implements one of them, LAS, by adding an
adaptor layer and a wire encoding to the unmodified CRYSTALS-Dilithium reference

...
The applications remain exploratory, since the swap study runs over a ledger model and the
...
\begin{itemize}
  ...
  \item \textbf{Reduce the cost of one-transaction verification.} Fitting under the cap was
        ...
        length: a full claim at the target setting, verification alone at the smaller set,
        and at the largest, one transaction exceeded by derivation. Fitting is not the same as being worth doing: settlement

...
different machine, and its pinned value is what the second implementation is checked against
(\cref{sec:rustport}).
...
paper notation, holds the witness $y$ and therefore moves first;
